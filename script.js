/* Prajwal E. Portfolio - Main JavaScript (Multi-Page Version)
   Features: Smart Boot, FEA Mesh, Synchro-Gears, Mech-Audio, Page Specific Logic
*/
...
if (bootScreen) {
    ...
    // Apply sound to all interactive elements
    ...
    /* =========================================
       5. DECIPHER TEXT EFFECT (Headers)
    ========================================= */
    const letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    // Target both Card Headers and Section Headers
    const headers = document.querySelectorAll('.card h3, h1, .header-title');
    ...
    /* =========================================
       7. TYPEWRITER EFFECT (Only if Subtitle exists)
    ========================================= */
    ...
    /* =========================================
       9. MODAL & GALLERY (Safe Check)
    ========================================= */
    const modal = document.getElementById('project-modal');
    const closeBtn = document.querySelector('.close-modal');
    // We use a class to identify any card that triggers the modal
    const projectTriggers = document.querySelectorAll('.project-card'); 

    // Define images globally or per project logic (Simplified for now)
    const projectImages = [
        "assets/IMG-20251206-WA0058.jpg",
        "assets/IMG-20251206-WA0058.jpg", // Add more unique paths if available
        "assets/IMG-20251206-WA0058.jpg"
    ];
    let currentSlide = 0;
    ...
    /* =========================================
       10. EDUCATION TRACKER (Safe Check)
    ========================================= */
    const eduCard = document.getElementById('edu-card');
    if (eduCard) {
        // Automatically trigger tracking if on Education Page
        if (window.location.href.includes('education') || window.location.href.includes('about')) {
            setTimeout(() => {
                 eduCard.classList.add('tracking');
            }, 500);
        }
    ...
    setInterval(() => {
        if (document.hidden) {
            ...
            // Only rotate if on Home, otherwise keep page specific title usually
            // But for style, we can append:
            titleIndex = (titleIndex + 1) % titleAlt.length;
            // Optional: Keep it simple or rotate
            // document.title = `Prajwal E. | ${titleAlt[titleIndex]}`;
        }
    }, 2500);

    /* =========================================
       14. KINETIC SCROLL PHYSICS
    ========================================= */
